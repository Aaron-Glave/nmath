...
1. `openssl ecparam -name secp521r1 -genkey -out key.pem` generates a private key with a NIST/SECG curve over a 521 bit prime field.
  - The `secp521r1` refers to an elliptic curve generated by the [National Institute of Standards and Technology (U.S. Department of Commerce)](https://www.nist.gov/).
